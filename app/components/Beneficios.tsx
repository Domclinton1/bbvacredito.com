  ...
  return (
    <section className="bg-gray-50 py-20" id="beneficios">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-3xl font-semibold mb-12 text-[#001394]">
          {t.beneficios_title}
        </h2>
        <p className="text-[#001394] mb-12">{t.beneficios_title}</p>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow">
            <h3 className="font-semibold text-lg mb-2 text-[#001394]">
              {t.beneficio1_title}
            </h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            <h3 className="text-[#001394] font-semibold text-lg mb-2">
              {t.beneficio2_title}
            </h3>
